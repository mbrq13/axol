...
- The `lerobot` extra installed on the main host: `uv sync --extra lerobot` (add `--extra video` to also see the camera feeds in the headset — see [Installation](/installation)).
