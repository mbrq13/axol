...
| **Self-hosted** | `https://<host>:8090/` | Served from your own machine by [`axol serve`](/cli/serve), or by `npm run dev` for development. Use when iterating on the interface or running fully offline. |
